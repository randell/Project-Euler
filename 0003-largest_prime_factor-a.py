...
Solution:
Create a function to check if a number is prime, then use this function to check 
if the factors if the given number are primes, while keeping track of the 
largest one. We set the number itself as the largest prime factor in case we 
don't find any other factors.
