...
Solution:
This version utilizes the formula for getting the sum of an arithmetic series.
...
sum_3 = sum_of_arithmetic_series(count_multiples_of_3, 3, 3)
sum_5 = sum_of_arithmetic_series(count_multiples_of_5, 5, 5)
sum_15 = sum_of_arithmetic_series(count_multiples_of_15, 15, 15)
