...
Solution:
Prepare a function to determine the Collatz sequence length of x. Loop up to 
just under one million until we find the longest chain.

Answer: 837799
I'm the 92,318th person to solve this problem.
